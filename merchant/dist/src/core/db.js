...
const connection = () => __awaiter(void 0, void 0, void 0, function* () {
    const sequelize = new sequelize_typescript_1.Sequelize({
        ...
        logging: false,
        dialectOptions: {
            ssl: postgres.host.includes("rds.amazonaws.com") || config_1.applicationConfig.nodeEnv === "production"
                ? {
                    require: true,
        ...
        models: [Merchant_model_1.Merchant, MerchantVerification_model_1.MerchantVerification, StoreDetails_model_1.StoreDetails, PaymentDetails_model_1.PaymentDetails, MerchantSettings_model_1.MerchantSettings, Product_model_1.Product, Discount_model_1.Discount, Category_model_1.Category, RefreshToken_model_1.RefreshToken],
    });
    try {
