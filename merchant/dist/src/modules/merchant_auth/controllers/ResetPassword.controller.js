...
const resetPassword = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error: validationError, value: payload } = validateSchema(MerchantAuth_schema_1.ResetPasswordSchema, cleanBody);
    if (validationError) {
    ...
    const [error, data] = yield manageAsyncOps(MerchantAuth_service_1.MerchantAuthService.resetPassword(payload));
    if (error) {
        return next(manageApplicationErrors({
