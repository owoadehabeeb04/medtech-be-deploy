...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { error, value } = (0, utils_1.validateSchema)(Discount_schema_1.updateDiscountSchema, req.body);
        if (error) {
            res.status(400);
            res.response = {
                message: error,
        ...
        const discount = yield Discount_service_1.DiscountService.updateDiscount(merchantId, discountId, value);
        res.status(200);
        res.response = {
