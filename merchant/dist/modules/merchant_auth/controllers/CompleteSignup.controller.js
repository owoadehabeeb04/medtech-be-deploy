...
const completeSignup = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { error: validationError, value: payload } = validateSchema(MerchantAuth_schema_1.CompleteSignupSchema, cleanBody);
    if (validationError) {
    ...
    const [error, data] = yield manageAsyncOps(MerchantAuth_service_1.MerchantAuthService.completeSignup(payload));
    if (error) {
        console.log(error);
        return next(manageApplicationErrors({
