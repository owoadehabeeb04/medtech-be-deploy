...
/**
 * @swagger
 * /api/v1/merchant/subscriptions/cancel-downgrade:
 *   post:
 *     summary: "Cancel downgrade"
 *     description: "Cancel downgrade for the merchant API."
 *     operationId: "merchant_post_api_v1_merchant_subscriptions_cancel_downgrade"
 *     tags: ["Subscriptions"]
 *     security: [{ bearerAuth: [] }]
 *     requestBody:
 *       required: true
