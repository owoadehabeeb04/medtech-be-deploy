...
/**
 * @swagger
 * /api/v1/merchant/subscriptions/confirm-payment:
 *   post:
 *     summary: "Confirm payment"
 *     description: "Confirm payment for the merchant API."
 *     operationId: "merchant_post_api_v1_merchant_subscriptions_confirm_payment"
 *     tags: ["Subscriptions"]
 *     security: [{ bearerAuth: [] }]
 *     requestBody:
 *       required: true
 ...
 *           application/json:
 *             schema:
 *               $ref: "#/components/schemas/ConfirmSubscriptionPaymentResponse"
 *       400:
